...
const styles = `
  ...
  .somee-about { font-family: 'Inter', sans-serif; background: #f7f4ee; color: #1a1a1a; overflow-x: hidden; }
  ...
  .s-card-label { font-size: .7rem; letter-spacing: 2.5px; text-transform: uppercase; color: #f0c96e; margin-bottom: 20px; }
  .s-check-list { list-style: none; display: flex; flex-direction: column; gap: 12px; }
  .s-check-list li { display: flex; align-items: center; gap: 12px; font-size: .88rem; color: rgba(255,255,255,.85); }
  .s-tick {
  ...
  .s-img-badge {
    ...
    background: #1e4d35; color: #fff; border-radius: 12px; padding: 12px 18px;
    font-size: .8rem; line-height: 1.5;
  }
  .s-img-badge strong { display: block; font-size: 1rem; color: #f0c96e; margin-bottom: 2px; }
  ...
  .s-tech .s-sec-eyebrow { color: #f0c96e; }
  .s-tech .s-sec-title { color: #fff; }
  .s-tech .s-divider { background: #f0c96e; }
  .s-tech .s-body { color: rgba(255,255,255,.72); margin-bottom: 40px; }
  ...
  .s-tech-card h4 { font-size: .95rem; font-weight: 700; color: #f0c96e; margin-bottom: 8px; }
  .s-tech-card p { font-size: .84rem; line-height: 1.65; color: rgba(255,255,255,.62); }
  ...
  .s-big-num { font-family: 'Playfair Display', serif; font-size: 4.5rem; color: #f0c96e; line-height: 1; }
  .s-why-visual p { color: rgba(255,255,255,.78); font-size: .95rem; line-height: 1.65; }
  .s-cta-btn {
  ...
  .s-f-brand-name { font-size: 1.3rem; font-weight: 800; color: #fff; }
  .s-f-brand-sub { font-size: .6rem; letter-spacing: 3px; text-transform: uppercase; color: #f0c96e; display: block; margin-bottom: 14px; }
  .s-f-brand-desc { font-size: .85rem; line-height: 1.7; color: rgba(255,255,255,.55); }
  .s-f-col h4 { font-size: .74rem; text-transform: uppercase; letter-spacing: 2.5px; color: #f0c96e; margin-bottom: 16px; font-weight: 600; }
  .s-f-col ul { list-style: none; display: flex; flex-direction: column; gap: 9px; }
  .s-f-col ul a { font-size: .85rem; color: rgba(255,255,255,.62); text-decoration: none; transition: color .2s; }
  .s-f-col ul a:hover { color: #fff; }
  .s-f-contact { display: flex; align-items: center; gap: 9px; font-size: .85rem; color: rgba(255,255,255,.65); margin-bottom: 10px; }
  .s-footer-bottom {
